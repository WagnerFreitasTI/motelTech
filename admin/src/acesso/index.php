...
if (($_SERVER['REQUEST_METHOD'] == 'GET'))
{
    ...
    if (isset($_GET['op']) )
    {
        ...
        //LISTA TODAS SUITES
        if ($operacao == "todos_acesso")
        {
                $retorno_json['status'] = "sucesso";
                $retorno_json['data'] = busca_all_acesso($pdo);
        ...
        $operacao = $_POST['op'];
           ...
           //DELETAR
            ...
            if (  isset( $_POST['id_acesso'] )){
                ...
                $device = protect( $_POST['id_acesso']);
                $retorno_json['status'] = deletar_acesso($pdo,$device) ? "sucesso":"erro";
