                        ...
                        <div class="content" style="margin-top:-15px">
                            ...
                            <div class="card">
                                <div class="card-header d-flex align-items-center">
                                    ...
                                    <a onClick="adicionar_usuario()" style="background-color: #9700bd;border-color:#9700bd"
                                        class="btn btn-outline-primary btn-icon w-32px h-32px rounded-pill ms-auto">
