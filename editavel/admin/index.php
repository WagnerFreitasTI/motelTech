                        ...
                        <div class="card mb-10">
                            <div class="card-body">
                                <div class="text-center mb-5">
                                    <div class="d-inline-flex align-items-center justify-content-center mb-20 mt-2">
                                        <img src="assets/images/logo.png" class="h-22px " alt="">
                                    </div>
                                <!-- <h6 class="mb-0">Autenticação</h6>
                                ...
                                <div class="mb-3">
                                    <button  class="btn btn-warning w-100" id="autenticar">Autenticar</button>
                                </div>
