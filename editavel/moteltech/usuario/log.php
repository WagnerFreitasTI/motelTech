                        ...
                        <div class="content" style="margin-top:-15px">
                            ...
                            <div class="card">
                                <div class="card-header d-flex align-items-center">
                                    <h5 class="mb-0">Logs de autenticação</h5>
                                ...
                                <div class="table-responsive" style="width:1000px; margin: 0 auto;">
                                    <table class="table" id="tabela_usuarios_log" name="tabela_usuarios_log">
                                        <thead>
                                            <tr>
...
<!-- JS USUARIO -->
<script src="../../assets/js/usuario/usuario_log.js"></script>
