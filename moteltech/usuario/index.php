...
<head>
    ...
    <title>MotelTech - Usuários</title>
                        ...
                        <div class="content" style="margin-top:-15px">
                            ...
                            <div class="card">
                                <div class="card-header d-flex align-items-center">
                                    ...
                                    <a onClick="adicionar_usuario()" style="background-color: #9700bd;border-color:#9700bd" class="btn btn-outline-primary btn-icon w-32px h-32px rounded-pill ms-auto">
                                        <i class="ph-plus" style="color:white"></i>
                                    </a>
                                </div>
                                ...
                                <div class="table-responsive" style="width:1000px; margin: 0 auto;">
                                    <table class="table" id="tabela_usuarios" name="tabela_usuarios">
                                        <thead>
                                            <tr>
