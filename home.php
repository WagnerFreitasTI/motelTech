...
// Inclui outras dependências e funções necessárias
...
<head>
    <title><?= htmlspecialchars($nome_cliente) . " | " . htmlspecialchars($nome_sistema) ?> </title>
    <meta charset="utf-8">
...
<body class="is-preload">
    ...
    <div id="wrapper">
        <!-- Header -->
        <header id="header">
            <a href="#" class="logo"><strong><?= htmlspecialchars($nome_sistema) ?></strong></a>
            <p class="nomesuite">Medieval - <?= htmlspecialchars($suite['numero']) ?> <?= htmlspecialchars($suite['nome']) ?></p>
        ...
        <div id="main">
            ...
            <section id="one" class="tiles">
                ...
                <article class="homearticles">
                    ...
                    <header class="major">
                        ...
                        <p>Estamos prontos para te atender por aqui.</p>
                    </header>
                </article>
            ...
            <section id="two">
                <div class="inner">
                    ...
                    <p>A Lei Geral de Proteção de Dados Pessoais (LGPD), Lei n° 13.709/2018, foi promulgada para proteger os direitos fundamentais de liberdade e de privacidade e a livre formação da personalidade de cada indivíduo. A Lei fala sobre o tratamento de dados pessoais, dispostos em meio físico ou digital, feito por pessoa física ou jurídica de direito público ou privado, englobando um amplo conjunto de operações que podem ocorrer em meios manuais ou digitais.</p>
    ...
    <script>
        const url_node_red = <?= json_encode($url_node_red) ?>;
        const suite = <?= json_encode($suite['id']) ?>;
        const suite_token = <?= json_encode($suite['token']) ?>;
        var time_out_status_rele; // Atualiza status do rele
        var aviso_erro; // Erro ao setar rele
        var is_tablet = <?= json_encode($istablet) ?>;
    </script>
